...
CREATE TABLE `recovered` (
    ...
    `increase_of_recovered` INT NOT NULL,
    PRIMARY KEY (`country`, `date`),
    CONSTRAINT `fk_recovered_country_date` FOREIGN KEY (`country`, `date`)
        REFERENCES `confirmed` (`country`, `date`)
);
...
CREATE TABLE `death` (
    ...
    `increase_of_deaths` INT NOT NULL,
    PRIMARY KEY (`country`, `date`),
    CONSTRAINT `fk_death_country_date` FOREIGN KEY (`country`, `date`)
        REFERENCES `confirmed` (`country`, `date`)
);
